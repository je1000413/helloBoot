...
import com.mice.backoffice.c2v_mice_backoffice_api.model.convention.coupon.CouponListSqlRequest;
import com.mice.backoffice.c2v_mice_backoffice_api.model.convention.coupon.CouponLogListRequest;
import com.mice.backoffice.c2v_mice_backoffice_api.model.convention.coupon.CouponLogListSqlRequest;
...
import com.mice.backoffice.c2v_mice_backoffice_api.slave.repository.CouponListLogRepository;
import com.mice.backoffice.c2v_mice_backoffice_api.slave.repository.CouponListRepository;
...
public class CouponListServiceImpl implements CouponListService {
    ...
    private final CouponListLogRepository couponListLogRepository;

    @Override
    @Transactional
    public C2VResponse listBySlave(CouponListRequest req) {
        ...
        List<CouponListEntity> list = couponListRepository.findCouponListEntitiesByCondition(
                couponListSqlRequest.getStartCreateDatetime()
                , couponListSqlRequest.getEndCreateDatetime()
                , couponListSqlRequest.getStartEventDatetime()
                , couponListSqlRequest.getEndEventDatetime()
                , couponListSqlRequest.getStartUpdateDatetime()
                , couponListSqlRequest.getEndUpdateDatetime()
                , couponListSqlRequest.getStateCode()
                , couponListSqlRequest.getStaffType()
                , couponListSqlRequest.getPackageName()
                , couponListSqlRequest.getPackageId()
                , couponListSqlRequest.getEventName()
                , couponListSqlRequest.getEventId()
                , couponListSqlRequest.getCompanyName()
                , couponListSqlRequest.getCompanyId()
                , couponListSqlRequest.getPageSize()
                , couponListSqlRequest.getPageNum()
        );
    ...
    @Override
    @Transactional
    public C2VResponse loglistBySlave(CouponLogListRequest req) {
        ...
        List<CouponListLogEntity> list = couponListLogRepository.findCouponListLogEntitiesByCondition(
                couponLogListSqlRequest.getStartCreateDatetime()
                , couponLogListSqlRequest.getEndCreateDatetime()
                , couponLogListSqlRequest.getStartEventDatetime()
                , couponLogListSqlRequest.getEndEventDatetime()
                , couponLogListSqlRequest.getCouponLogType()
                , couponLogListSqlRequest.getPackageName()
                , couponLogListSqlRequest.getPackageId()
                , couponLogListSqlRequest.getEventName()
                , couponLogListSqlRequest.getEventId()
                , couponLogListSqlRequest.getCompanyName()
                , couponLogListSqlRequest.getCompanyId()
                , couponLogListSqlRequest.getPageSize()
                , couponLogListSqlRequest.getPageNum()
        );
